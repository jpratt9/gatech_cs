...
def getNNExtraData(fileString="datasets/winequality.txt", limit=100000):
    """
...
def buildExamplesFromExtraData(size=10000):
    ...
    """
    if (size != 10000):
        extraDataTrainList = getNNExtraData("datasets/winequalityTrain.txt",int(.8*size))
        extraDataTestList = getNNExtraData("datasets/winequalityTest.txt",int(.2*size))
    else :
        extraDataTrainList = getNNExtraData("datasets/winequalityTrain.txt")
        extraDataTestList = getNNExtraData("datasets/winequalityTest.txt")
